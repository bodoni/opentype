...
implement! {
    ...
    b"ccmp" => "Glyph Composition / Decomposition" => GlyphCompositionDecomposition,
    ...
    b"jp78" => "JIS1978 Forms" => JIS1978Forms,
    b"jp83" => "JIS1983 Forms" => JIS1983Forms,
    b"jp90" => "JIS1990 Forms" => JIS1990Forms,
    ...
    b"medi" => "Medial Forms" => MedialForms,
